...
def predict(test_sentences, feature_names, f_out):
    ...
    for test_sentence in test_sentences:
        ...
        for word in rows:
            ...
            y_predicted_long.append(y_test_predicted[0])
            y_long.append(y_test[0])
            y_pred['chunk_n2'] = y_pred['chunk_n1']
            y_pred['chunk_n1'] = y_test_predicted
            f_out.write(word + ' ' + y_test_predicted[0] + '\n')
            i += 1
...
if __name__ == '__main__':
   ...
   # classifier = linear_model.LogisticRegression(penalty='l2', dual=False, solver='lbfgs')
